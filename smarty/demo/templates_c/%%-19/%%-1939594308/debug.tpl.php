<?php /* Smarty version 2.5.0, created on 2003-09-17 00:02:36
         compiled from file:/kunden/esentri.de/webseiten/smarty250/libs/debug.tpl */ ?>
<?php $this->_load_plugins(array(
array('function', 'assign_debug_info', 'file:/kunden/esentri.de/webseiten/smarty250/libs/debug.tpl', 5, false),
array('modifier', 'string_format', 'file:/kunden/esentri.de/webseiten/smarty250/libs/debug.tpl', 12, false),
array('modifier', 'debug_print_var', 'file:/kunden/esentri.de/webseiten/smarty250/libs/debug.tpl', 18, false),)); ?>



<?php echo $this->_plugins['function']['assign_debug_info'][0](array(), $this) ; ?>
...
$this->_sections['templates']['loop'] = is_array($this->_tpl_vars['_debug_tpls']) ? count($this->_tpl_vars['_debug_tpls']) : max(0, (int)$this->_tpl_vars['_debug_tpls']);
...
?>
		<tr bgcolor=<?php if (!($this->_sections['templates']['index'] % 2)): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td colspan=2><tt><?php if (isset($this->_sections['indent'])) unset($this->_sections['indent']);
$this->_sections['indent']['name'] = 'indent';
$this->_sections['indent']['loop'] = is_array($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth']) ? count($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth']) : max(0, (int)$this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth']);
...
?>&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?><font color=<?php if ($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['type'] == 'template'): ?>brown<?php elseif ($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['type'] == 'insert'): ?>black<?php else: ?>green<?php endif; ?>><?php echo $this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['filename']; ?>
</font><?php if (isset ( $this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['exec_time'] )): ?> <font size=-1><i>(<?php echo $this->_run_mod_handler('string_format', true, $this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['exec_time'], "%.5f"); ?>
...
$this->_sections['vars']['loop'] = is_array($this->_tpl_vars['_debug_keys']) ? count($this->_tpl_vars['_debug_keys']) : max(0, (int)$this->_tpl_vars['_debug_keys']);
...
?>
		<tr bgcolor=<?php if (!($this->_sections['vars']['index'] % 2)): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td valign=top><tt><font color=blue>{$<?php echo $this->_tpl_vars['_debug_keys'][$this->_sections['vars']['index']]; ?>
}</font></tt></td><td nowrap><tt><font color=green><?php echo $this->_run_mod_handler('debug_print_var', false, $this->_tpl_vars['_debug_vals'][$this->_sections['vars']['index']]); ?>
</font></tt></td></tr>
	<?php endfor; else: ?>
...
$this->_sections['config_vars']['loop'] = is_array($this->_tpl_vars['_debug_config_keys']) ? count($this->_tpl_vars['_debug_config_keys']) : max(0, (int)$this->_tpl_vars['_debug_config_keys']);
...
?>
		<tr bgcolor=<?php if (!($this->_sections['config_vars']['index'] % 2)): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td valign=top><tt><font color=maroon>{#<?php echo $this->_tpl_vars['_debug_config_keys'][$this->_sections['config_vars']['index']]; ?>
#}</font></tt></td><td><tt><font color=green><?php echo $this->_run_mod_handler('debug_print_var', false, $this->_tpl_vars['_debug_config_vals'][$this->_sections['config_vars']['index']]); ?>
</font></tt></td></tr>
	<?php endfor; else: ?>
...
$this->_sections['templates']['last']       = ($this->_sections['templates']['iteration'] == $this->_sections['templates']['total']);
?>
		_smarty_console.document.write("<tr bgcolor=<?php if (!($this->_sections['templates']['index'] % 2)): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td colspan=2><tt><?php if (isset($this->_sections['indent'])) unset($this->_sections['indent']);
$this->_sections['indent']['name'] = 'indent';
$this->_sections['indent']['loop'] = is_array($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth']) ? count($this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth']) : max(0, (int)$this->_tpl_vars['_debug_tpls'][$this->_sections['templates']['index']]['depth']);
$this->_sections['indent']['show'] = true;
$this->_sections['indent']['max'] = $this->_sections['indent']['loop'];
...
$this->_sections['vars']['last']       = ($this->_sections['vars']['iteration'] == $this->_sections['vars']['total']);
?>
		_smarty_console.document.write("<tr bgcolor=<?php if (!($this->_sections['vars']['index'] % 2)): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td valign=top><tt><font color=blue>{$<?php echo $this->_tpl_vars['_debug_keys'][$this->_sections['vars']['index']]; ?>
}</font></tt></td><td nowrap><tt><font color=green><?php echo $this->_run_mod_handler('debug_print_var', false, $this->_tpl_vars['_debug_vals'][$this->_sections['vars']['index']]); ?>
</font></tt></td></tr>");
	<?php endfor; else: ?>
...
$this->_sections['config_vars']['last']       = ($this->_sections['config_vars']['iteration'] == $this->_sections['config_vars']['total']);
?>
		_smarty_console.document.write("<tr bgcolor=<?php if (!($this->_sections['config_vars']['index'] % 2)): ?>#eeeeee<?php else: ?>#fafafa<?php endif; ?>><td valign=top><tt><font color=maroon>{#<?php echo $this->_tpl_vars['_debug_config_keys'][$this->_sections['config_vars']['index']]; ?>
#}</font></tt></td><td><tt><font color=green><?php echo $this->_run_mod_handler('debug_print_var', false, $this->_tpl_vars['_debug_config_vals'][$this->_sections['config_vars']['index']]); ?>
</font></tt></td></tr>");
	<?php endfor; else: ?>
